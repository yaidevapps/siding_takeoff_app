        ...
        if submit_button:
            ...
            try:
                ...
                if len(pdf_document) > 1:
                    ...
                    page = pdf_document[0]
                    # Reduce resolution to manage memory
                    ...
                    try:
                        ...
                        img_bytes.seek(0)
                        st.image(img_bytes, caption="Uploaded Plan Preview", use_container_width=True)
                        logger.info("Displayed image preview")
                    except Exception as e:
                        st.error(f"Failed to display plan preview: {str(e)}")
